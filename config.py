...
class mainConfig(Config):
    ...
    # (128, 128) https://openaccess.thecvf.com/content_cvpr_2018_workshops/papers/w4/Zhao_Building_Extraction_From_CVPR_2018_paper.pdf
    # USE_MINI_MASK = True
    ...
    # 0 for non-overlapping predicted reigons
